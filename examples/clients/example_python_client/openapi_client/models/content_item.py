...
class ContentItem(BaseModel):
    ...
    ContentItem
    """ # noqa: E501
    type: StrictStr = Field(description="The type of content, such as text or image URL.")
    text: Optional[StrictStr] = Field(default=None, description="The text content. Required if type is 'text'.")
    image_url: Optional[object] = Field(default=None, description="The image URL object. Required if type is 'image_url'.")
    source: Optional[object] = Field(default=None, description="The source object. Required if type is 'image'.")
