...
class Metadata(BaseModel):
    ...
    Metadata
    """ # noqa: E501
    model: StrictStr = Field(description="The name of the model used to generate the response.")
    tokens: Optional[StrictStr] = Field(default=None, description="The number of tokens used to generate the response.")
    __properties: ClassVar[List[str]] = ["model", "tokens"]
