...
class Message(BaseModel):
    ...
    Message
    """ # noqa: E501
    role: StrictStr = Field(description="Role of the message sender. Examples include: - `system`: For system messages - `user`: For messages from the user - `assistant`: For messages from the assistant ")
